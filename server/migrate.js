...
const books = [
  ...
  { title: "Charlie, O Jovem Adulto",              author: "Ângulo de Vista",     category: "HQ",        pages: 128,  year: 2022, status: "finished", start_date: excelDateToISO(44891), end_date: excelDateToISO(44892), rating: starsToNumber("★★★★★") },
  { title: "O Livro Sagrado Pacão",                author: "Carlos Ruas",         category: "HQ",        pages: 96,   year: 2022, status: "finished", start_date: excelDateToISO(44893), end_date: excelDateToISO(44893), rating: starsToNumber("★★★★⯪") },
  { title: "Bíblia Gatólica",                      author: "Carlos Ruas",         category: "HQ",        pages: 96,   year: 2022, status: "finished", start_date: excelDateToISO(44893), end_date: excelDateToISO(44893), rating: starsToNumber("★★★★⯪") },
  { title: "A Máscara de Togi",                    author: "Mari Santos",         category: "HQ",        pages: 194,  year: 2022, status: "finished", start_date: excelDateToISO(44893), end_date: excelDateToISO(44893), rating: starsToNumber("★★★★★") },
  { title: "O Último Jogo",                        author: "Mari Santos",         category: "HQ",        pages: 22,   year: 2022, status: "finished", start_date: excelDateToISO(44911), end_date: excelDateToISO(44911), rating: starsToNumber("★★★★") },
